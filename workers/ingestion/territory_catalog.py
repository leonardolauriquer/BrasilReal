...
METRIC_DEFINITIONS: dict[str, dict] = {
    ...
    "lens_live": {
        "definition": (
            ...
            "(renda, trabalho invertido, segurança invertida, serviços), "
            "min–máx de camadas oficiais já no mapa. Não é IDHM."
        ),
        "source": {
    ...
    "lens_venture": {
        "definition": (
            ...
            "(dinâmica de empregadoras, mercado formal, densidade de empresas por mil hab.). "
    ...
    "lens_family": {
        "definition": (
            "Nota 0–100 para «criar criança»: renda, desocupação invertida, "
            "segurança invertida e serviços do Censo. Sem PNS 2019. Não é IDEB."
        ),
        "source": {
            "organization": "Brasil Real",
